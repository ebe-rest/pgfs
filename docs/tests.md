...
| **The Citus mkfs matrix** | 18 | The behaviour of the combinations of `mkfs --citus / --worker / --clean` (new / keeping an existing one / rebuilding) | [tests/citus/test_matrix.sh](../tests/citus/test_matrix.sh) | [tests/citus/README.md](../tests/citus/README.md) |
...
| The Citus mkfs matrix | **18/18 PASS** (re-run 2026-09-21) | Citus 14.0.0 on docker on the Linux client |
