...
public class Api : System.IDisposable
{
	...
	/// <summary>
	/// The filesystem's nominal capacity (derived from <see cref="Pgfs.Core.Config.FileSystemConfig.MaxFileSize"/>, saved in pgfs.toml).
	/// </summary>
	...
	// (which adopts `Pgfs.Core.Config.FileSystemConfig.DefaultChunkSize` at the first INSERT).
	//
